...
const treatments = {
  ...
  bedbug: {
    text: {
      th: "🛏️ แมลงสาบกัด<br>- ล้างบริเวณที่โดนด้วยน้ำและสบู่อ่อน<br>- ประคบเย็นเพื่อลดคันและบวม<br>- ทาคาลาไมน์หรือครีมสเตียรอยด์อ่อน<br>- หลีกเลี่ยงการเกา<br>🛡️ การป้องกัน: ซักผ้าปูที่นอนด้วยน้ำร้อน, ทำความสะอาดที่นอนและห้องนอนสม่ำเสมอ",
